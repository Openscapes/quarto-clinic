...
If you created a new page, how do you get it in the book? This involves editing `_quarto.yml` to have it show up in site

### Update `_quarto.yml`

Now we'll add `python-yourname.ipynb` or `newfile.qmd` to our `_quarto.yml` file; this is where we register all files to include in our site.
